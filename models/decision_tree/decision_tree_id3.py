...
class ID3DecisionTree:
    ...
    def _best_split(self, X, y):
        ...
        best_feature, best_threshold, best_ig = None, None, -float('inf')
        ...
        for feat_idx in range(n_features):
            ...
            for threshold in thresholds:
                ...
                ig = self._information_gain(y, splits)
...
def decision_tree_id3():
    ...
    for d in depth_range:
        m = ID3DecisionTree(max_depth=d, min_samples_split=10)
    ...
    ax.set_title('ID3：max_depth 敏感性分析')
    ax.set_xlabel('max_depth')
    ax.set_ylabel('Accuracy')
    ax.legend()
    ax.grid(True, alpha=0.3)

    save_path = get_results_path('decision_tree_id3_result.png')
